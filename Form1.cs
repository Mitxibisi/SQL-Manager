...
//Añadir usuario Guest para correcto funcionamiento
namespace DinApp
{
    public partial class Form1 : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            string password = txtPassword.Text;  // txtPassword es el TextBox para la contraseña User Id={userId}; Password = {password};
